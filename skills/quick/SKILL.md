---
name: quick
description: Create minimal handoff documentation for straightforward tasks
model: sonnet
---

# Create Quick Handoff Documentation
...
Use **create** (the comprehensive version) when:
...
To resume: Use /reheating:resume or /reheating:resume-quick (for same-day continuation)
```
